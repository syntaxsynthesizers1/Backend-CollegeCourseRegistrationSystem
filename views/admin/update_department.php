      ...
      <div class="row">
        <div class="col-md-12">
            ...
            <img src="../../assets/images/admin/department-icon.png">
                <h1 class="text-light">Update department</h1>
            </div>
        </div>
      </div>   
  </div>
      ...
      <div class="row justify-content-center shadow align-items-center py-3 rounded">
          ...
          <div class="col-md-6">
              <div class="content ms-md-4">
                  <h2 class="sub-heading">Update Department</h2>
                  <?php
                  ...
                  <select name="faculty" id="">
                    ...
                    <input type="text" name="name" placeholder="Enter department" value="<?= $department['name'] ?>"  required>
                    <input type="hidden" name="id" value="<?= $department['id'] ?>">
                    <input type="hidden" name="update-department">
